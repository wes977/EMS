/*
* Name: EmployeeValidator.cs
*
* Programmers: Kyle Kreutzer, Kyle Marshall, Wes Thompson Colin Mills
*
* Date: 04/21/2016
*
* Description:
* Holds the employee validator class and associated enums.
*
*/
...
{
    /// <summary>
    /// Specifies errors generated by the employee validator.
    /// </summary>
    public enum Errors
    {
        Ok,
        ...
        InvalidSeasonYearLength,
        InvalidSeasonYearFormat,
        FirstNameBlank,
        LastNameBlank
    };
    ...
    public class EmployeeValidator
    {
        ...
        /// <summary>
        /// Validates the birthdate of an employee, making sure it is
        /// in proper format and that the employee is old enough to work
        ...
        public void ValidateBirthDate(string date, EmployeeType type)
        {
            ...
            if (ValidateDateFormat(date) == false)
            {
                ...
                status = Errors.InvalidBirthDateFormat;
            }
        ...
        /// <summary>
        /// Validates that a season year only contains 4 digits, and exists.
        /// </summary>
        /// <param name="date">Season year to validate</param>
        public void ValidateSeasonYear(string date)
        {
            /* Ensure there is only 4 characters in date string */
            if (date.Length != 4)
            {
                AddError(Errors.InvalidSeasonYearLength);
            }
            else
            {
                /* Check the format of the year */
                date += "/01/01";
                if (ValidateDateFormat(date) == false)
                {
                    AddError(Errors.InvalidSeasonYearFormat);
                }
            }
        }

        /// <summary>
        /// Validates a start date and an end date, making
        /// sure they are not blank and that the end date isn't
        ...
        /// <summary>
        /// Validates that a date is in the proper format and
        /// not blank.
        /// </summary>
        /// <param name="date">The date to check formatting for.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Validates a date of field i.e. date of hire
        /// and date of termination, making sure that they
        /// follow their specified rules.
        /// </summary>
        /// <param name="date">The date to validate</param>
        /// <param name="dateOf">Date of hire or date of term</param>
        /// <returns></returns>
        ...
        /// <param name="AddErrors">Specifies if errors should be added to error list.</param>
        ...
        /// Validates the pay.
        /// </summary>
        /// <param name="pay">The pay amount</param>
        /// <returns> A boolean representing whether the salary was valid. </returns>
        public bool ValidatePay(string pay)
        {
            bool result = false;
            double parsedPay = 0;

            double.TryParse(pay, out parsedPay);
        ...
        /// <summary>
        /// Takes an error status, pushing it's accompanied error
        /// string to the class level error list.
        /// </summary>
        /// <param name="status">The error string to add</param>
        private void AddError(Errors status)
        {
            ...
            switch (status)
            {
                case Errors.InvalidBirthDateFormat:
                    errorString = "The birth date is blank or entered in an unrecognizable format.";
                    break;

                case Errors.InvalidDateOfHireFormat:
                    errorString = "The date of hire is blank or entered in an unrecognizable format.";
                    break;
                ...
                case Errors.InvalidSeasonYearLength:
                    errorString = "The season year must contain a year in YYYY format.";
                    break;

                case Errors.InvalidSeasonYearFormat:
                    errorString = "Invalid characters or format in season year. Valid input is YYYY format.";
                    break;
